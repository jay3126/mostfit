class Reports < Application
  ...
  Types = {
    ...
    :consolidated => [ConsolidatedReport, BranchWiseDisbursementAndChargeDetailsReport, SOFDuesCollectionAndAccrualsReport, MonthlyLoanDetailsReport, SofMonthlyLoanDetailsReport, BranchDateWiseDcaReport, DateWiseSofDuesCollectionsAndAccrualsReport, BranchDateWiseSofDuesCollectionsAndAccrualsReport, BranchDateWiseSofDuesCollectionsAndAccrualsFilteredWithLoanProductReport],
    ...
    :registers    => [CustomerExtractForInsurance, InsuranceClaimReport, CenterList, PassbookLabelExtract, SurpriseCenterExtract, OngoingLoanInformationReport, BranchReport, LoanStatusReport, PeriodicLoanStatusReport, OutreachCenterGroupCountReport, OutreachMembersReport, OutreachLoanDisbursementReport, DelinquencyReportBranchWise],
    :statistics => [DeviationReport, LoanApplicationsReport, CreditBureauReport, LoanFilesReport, MembersAndCentersPerRo, PreClosureCustomerDetails, SecuritisationPoolInformationReport, SecuritisationLoanDetailsReport, OverdueDetailedReport, AdvancePaymentsCurrentReport,  LoanExtractForSourceOfFundDetails],

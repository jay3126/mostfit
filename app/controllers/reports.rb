class Reports < Application
  ...
  Types = {
    ...
    :statistics   => [LoanSizePerManagerReport, LoanPurposeReport, ClientOccupationReport, ClosedLoanReport, MissingGuarantorReport, LastUpdateReport, CommonDataFormat], 

class Upload  
  ...
  MODELS = [:location_levels, :designations, :staff_members, :biz_locations, :simple_fee_products, :lending_products, :client_groups, :clients, :new_funding_lines, :new_tranches, :lendings]

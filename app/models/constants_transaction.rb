module Constants
  module Transaction
    ...
    PAYMENT_TOWARD_FOR_REPAYMENT = [PAYMENT_TOWARDS_LOAN_REPAYMENT, PAYMENT_TOWARDS_LOAN_ADVANCE_ADJUSTMENT,PAYMENT_TOWARDS_LOAN_RECOVERY]
    REVERT_PAYMENT_TOWARDS = [PAYMENT_TOWARDS_LOAN_PRECLOSURE, PAYMENT_TOWARDS_LOAN_REPAYMENT, PAYMENT_TOWARDS_LOAN_ADVANCE_ADJUSTMENT, PAYMENT_TOWARDS_LOAN_RECOVERY]

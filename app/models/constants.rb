module Constants
  ...
  module Status
    ...
    LOAN_APPLICATION_STATUSES =
      (CREATION_STATUSES + DEDUPE_STATUSES + OVERLAP_REPORT_STATUSES + AUTHORIZATION_STATUSES + CPV_STATUSES + LOAN_FILE_GENERATION_STATUSES + [CLIENT_CREATED]).flatten
  ...
  module Masters
    ...
    RELATIONSHIPS = ["Father", "Husband", "Mother", "Son", "Daughter", "Wife", "Brother", "Sister", "Mother-In-law", "Father-In-law", "Daughter-In-law", "Sister-In-Law", "Son-In-Law", "Brother-In-law", "Nephew", "Niece", "Legal-Guardian", "Other"]

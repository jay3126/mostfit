...
class CollectionSheetLineItem
  ...
  attr_reader :at_biz_location_id, :at_biz_location_name, :on_date, :borrower_id, :borrower_name, :borrower_group_id, :borrower_group_name,
               :loan_id, :loan_lan_no, :loan_disbursed_amount, :loan_status, :loan_disbursed_date, :loan_due_status, :loan_installment_number,
               ...
               :loan_actual_interest_outstanding, :loan_actual_total_due, :loan_principal_overdue, :loan_interest_overdue
  ...
  def initialize(at_biz_location_id, at_biz_location_name, on_date, borrower_id, borrower_name, borrower_group_id, borrower_group_name,
                  ...
                  loan_principal_overdue = MoneyManager.default_zero_money, loan_interest_overdue = MoneyManager.default_zero_money)
    ...
    @loan_actual_total_due               = loan_actual_total_due
    @loan_principal_overdue              = loan_principal_overdue
    @loan_interest_overdue               = loan_interest_overdue
    @loan_lan_no                         = loan_lan_no

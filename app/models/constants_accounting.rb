module Constants
  module Accounting
    ...
    CUSTOMER_LOAN_PRODUCT_SPECIFIC_LEDGER_TYPES = [CUSTOMER_LOAN_DISBURSED, CUSTOMER_LOAN_REPAID, CUSTOMER_LOAN_ADVANCE_RECEIPT, CUSTOMER_LOAN_INTEREST_RECEIPT, CUSTOMER_LOAN_FEE_RECEIPT]

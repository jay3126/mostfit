module Constants
  module Accounting
    ...
    REVERSE_ACCRUE_PRINCIPAL_ALLOCATION  = :reverse_accrue_principal_allocation
    ACCRUE_INTEREST_ALLOCATION           = :accrue_interest_allocation
    REVERSE_ACCRUE_INTEREST_ALLOCATION   = :reverse_accrue_interest_allocation
    REVERSE_ACCRUE_REGULAR               = :reverse_accrue_regular
    ...
    ACCRUAL_ALLOCATION_TYPES = [ACCRUE_PRINCIPAL_ALLOCATION, ACCRUE_INTEREST_ALLOCATION,REVERSE_ACCRUE_PRINCIPAL_ALLOCATION, REVERSE_ACCRUE_INTEREST_ALLOCATION]
    ACCRUAL_TEMPORAL_TYPES   = [ACCRUE_REGULAR, ACCRUE_BROKEN_PERIOD, REVERSE_BROKEN_PERIOD_ACCRUAL, REVERSE_ACCRUE_REGULAR]

    LOAN_ACCRUE_REGULAR_PRINCIPAL               = :loan_accrue_regular_principal
    LOAN_ACCRUE_REGULAR_INTEREST                = :loan_accrue_regular_interest
    LOAN_ACCRUE_REGULAR_PRINCIPAL_REVERSE       = :loan_accrue_regular_principal_reversal
    LOAN_ACCRUE_REGULAR_INTEREST_REVERSE        = :loan_accrue_regular_interest_reversal
    ...
    LOAN_ACCRUAL_PRODUCT_ACTIONS = [LOAN_ACCRUE_REGULAR_PRINCIPAL, LOAN_ACCRUE_REGULAR_INTEREST, LOAN_ACCRUE_BROKEN_PERIOD_INTEREST, LOAN_ACCRUE_BROKEN_PERIOD_INTEREST_REVERSAL, LOAN_ACCRUE_REGULAR_PRINCIPAL_REVERSE, LOAN_ACCRUE_REGULAR_INTEREST_REVERSE]
    ...
    PRODUCT_ACTIONS_FOR_ACCRUAL_TRANSACTIONS = {
      Constants::Products::LENDING => {
        ...
        REVERSE_ACCRUE_REGULAR => {
          REVERSE_ACCRUE_PRINCIPAL_ALLOCATION => LOAN_ACCRUE_REGULAR_PRINCIPAL_REVERSE ,
          REVERSE_ACCRUE_INTEREST_ALLOCATION  => LOAN_ACCRUE_REGULAR_INTEREST_REVERSE 
        }
      }
    }
    ...
    PRODUCT_ACTIONS = Constants::Transaction::PRODUCT_ACTIONS + LOAN_ACCRUAL_PRODUCT_ACTIONS + [MONEY_DEPOSIT, LOAN_DUE, WRITE_OFF, NON_RECEIVED_ACCRUAL_REVERSE, LOAN_ACCRUE_REGULAR_PRINCIPAL_REVERSE, LOAN_ACCRUE_REGULAR_INTEREST_REVERSE ]

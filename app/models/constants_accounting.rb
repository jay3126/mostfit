module Constants
  module Accounting
    ...
    PRODUCT_LEDGER_TYPES = [
        CUSTOMER_CASH, CUSTOMER_FEE_RECEIPT, CUSTOMER_LOAN_DISBURSED, CUSTOMER_LOAN_REPAID, CUSTOMER_LOAN_ADVANCE_RECEIPT, CUSTOMER_LOAN_INTEREST_RECEIPT, CUSTOMER_LOAN_FEE_RECEIPT
    ]

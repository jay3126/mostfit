module Constants
  module Accounting
    ...
    DEFAULT_LEDGERS = {CUSTOMER_CASH => 'Cash', CUSTOMER_BANK_ACCOUNT => 'Bank Account', CUSTOMER_LOAN_FEE_RECEIPT => 'Service Charges', CUSTOMER_LOAN_DISBURSED => 'Micro Finance Loan', CUSTOMER_LOAN_ADVANCE_RECEIPT => 'Advance for Ewi', CUSTOMER_LOAN_INTEREST_RECEIPT => 'Interest on Microfinance Loan',
      CUSTOMER_LOAN_DEBTORS => 'Debtors-Mf Loan', CUSTOMER_LOAN_OTHER_INCOME => 'Bad Debts Recover', CUSTOMER_LOAN_WRITE_OFF => 'Bad Debts'}
    ...
    LOAN_DUE = :loan_due
    WRITE_OFF = :write_off
    NON_RECEIVED_ACCRUAL_REVERSE = :non_received_accrual_reversed
    PRODUCT_ACTIONS = Constants::Transaction::PRODUCT_ACTIONS + LOAN_ACCRUAL_PRODUCT_ACTIONS + [MONEY_DEPOSIT, LOAN_DUE, WRITE_OFF, NON_RECEIVED_ACCRUAL_REVERSE]

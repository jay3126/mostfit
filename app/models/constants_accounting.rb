module Constants
  module Accounting
    ...
    CUSTOMER_LOAN_PRODUCT_SPECIFIC_LEDGER_TYPES = [CUSTOMER_LOAN_DISBURSED, CUSTOMER_LOAN_REPAID, CUSTOMER_LOAN_ADVANCE_RECEIPT, CUSTOMER_LOAN_INTEREST_RECEIPT, CUSTOMER_LOAN_FEE_RECEIPT, CUSTOMER_LOAN_DEBTORS, CUSTOMER_LOAN_OTHER_INCOME]
    ...
    LOAN_ACCRUAL_PRODUCT_ACTIONS = [LOAN_ACCRUE_REGULAR_PRINCIPAL, LOAN_ACCRUE_REGULAR_INTEREST, LOAN_ACCRUE_BROKEN_PERIOD_INTEREST]
    ...
    PRODUCT_ACTIONS = Constants::Transaction::PRODUCT_ACTIONS + LOAN_ACCRUAL_PRODUCT_ACTIONS

class PeriodicLoanStatusReport < Report
  ...
  def generate
    ...
    loan_ids_with_disbursal_dates.each do |l|
      ...
      loan_closure_date = (loan and loan.last_scheduled_date) ? loan.last_scheduled_date : "Not Specified"

class DelinquencyReport < Report
  ...
  def generate
    ...
    loan_hash.each do |status, values|
      ...
      scheduled_principal_due_till_date = (disbursed_principal_money_amt - scheduled_principal_outstanding_amt) + scheduled_principal_on_date
      scheduled_interest_due_till_date = (disbursed_interest_money_amt - scheduled_interest_outstanding_amt) + scheduled_interest_on_date
      ...
      if outstanding_principal.amount > MoneyManager.default_zero_money.amount

class DataAccessObserver
  ...
  observe *(DataMapper::Model.descendants.to_a - [AuditTrail] + [BizLocation, ClientGroup, Client, Lending, PaymentTransaction, StaffMember, SimpleFeeProduct, SimpleInsurancePolicy, CenterCycle, Mfi, LocationLevel, Funder, FundingLine, Tranch, ThirdParty]).uniq # strange bug where observer drops some of the descnedants.

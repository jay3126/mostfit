class DataAccessObserver
  ...
  observe *(DataMapper::Model.descendants.to_a - [AuditTrail] + [BizLocation, ClientGroup, Client, Lending, PaymentTransaction, StaffMember]).uniq # strange bug where observer drops some of the descnedants.

...
module CommonClient
  module Validations
    ...
    LOAN_APPLICATION_MAPPING  = {
      ...
      :client_telephone_number => :telephone_number
    }
    ...
    VALIDATIONS = {
      ...
      :reference => {:nullable => true, :length => 100, :format => Constants::ReferenceFormatValidations::FORMAT_REFERENCE1},
      :reference_type => {:default => Constants::Masters::DEFAULT_REFERENCE_TYPE},
      :reference2 => {:nullable => true, :format => Constants::ReferenceFormatValidations::FORMAT_REFERENCE2},

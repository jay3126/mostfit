...
HOUSE_TYPES = ['Thatched','Tiled','Sheet','RCC','Moulded','Cement','Tiled/Granite']

DRINKING_WATER_PROVISION = ['Own well/pipe','Other\'s well/pipe','Must bring water from a distance']

SANITATION_PROVISION = ['Own toilet, septic tank','No toilet']

TOTAL_MONTHLY_INCOME = ['Above 7000','Above 3000','Below 3000']

...
Merb::Router.prepare do
  ...
  resources :payment_transactions, :id => %r(\d+), :collection => {:payment_by_branch => [:get], :destroy_payment_transactions_on_date => [:get], :destroy_payment_transactions => [:get], :payment_transactions_on_date => [:get], :create_group_payments => [:get], :weeksheet_payments => [:get], :payment_form_for_lending => [:get], :payment_by_staff_member => [:get], :payment_by_staff_member_for_location => [:get]}

...
Merb::Router.prepare do
  ...
  resources :book_keepings, :collection => {:eod_process => [:get], :perform_eod_process => [:get,:post]}
  ...
  resources :user_locations, :id => %r(\d+), :member => {:weeksheet_collection => [:get]}, :collection => {:get_due_generation_sheet_for_location => [:get], :due_generation_for_location => [:get], :zip_file_download=>[:get]}
  ...
  resources :location_holidays, :id => %r(\d+), :collection => {:holiday_for_location => [:get], :create_holiday_for_location => [:put]}
  ...
  resources :biz_locations, :id => %r(\d+), :collection => {:map_locations => [:get]}, :member => {:update_biz_location => [:put], :biz_location_clients => [:get], :centers_for_selector => [:get], :biz_location_form => [:get], :loan_products => [:get]}
  ...
  resources :lendings, :id => %r(\d+), :member => {:reschedule_loan_installment => [:get], :save_reschedule_loan_installment => [:get,:put], :record_lending_preclose => [:put]}, :collection => {:bulk_lending_preclose => [:get], :record_bulk_lending_preclose => [:put], :write_off_lendings => [:get], :bulk_edit_funding_lines => [:get]}

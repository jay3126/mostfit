...
Merb::Router.prepare do
  ...
  resources :user_locations, :id => %r(\d+), :member => {:weeksheet_collection => [:get]}, :collection => {:branch_merge => [:get], :get_due_generation_sheet_for_location => [:get], :due_generation_for_location => [:get], :zip_file_download=>[:get]}

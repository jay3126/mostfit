...
Merb::Router.prepare do
  ...
  resources :new_clients, :collection => {:update_client_location => [:get,:put], :update_client_telephone_number => [:get,:put], :create_client_for_selected_loan_application => [:get, :put], :create_clients_for_loan_file => [:get], :death_claim_insurance => [:get, :put], :record_death_event => [:put, :get], :record_death_claim_insurance => [:get, :put], :all_deceased_clients => [:get, :put]}, :member => {:register_death_event => [:get], :client_and_loan_creation => [:get, :put]}
  resources :simple_insurance_policies
  resources :payment_transactions, :id => %r(\d+), :collection => {:advance_adjusted_on_date => [:get, :put], :advance_payment_by_location => [:get], :record_payment_by_branch => [:get, :put], :payment_by_branch => [:get], :destroy_payment_transactions_on_date => [:get], :destroy_payment_transactions => [:get], :payment_transactions_on_date => [:get], :create_group_payments => [:get], :weeksheet_payments => [:get], :payment_form_for_lending => [:get], :payment_by_staff_member => [:get], :payment_by_staff_member_for_location => [:get]}
  ...
  resources :lendings, :id => %r(\d+), :member => {:check_preclosure_date => [:get], :reschedule_loan_installment => [:get], :save_reschedule_loan_installment => [:get,:put], :record_lending_preclose => [:put]}, :collection => {:approve_write_off_lendings => [:put,:get], :bulk_lending_preclose => [:get], :record_bulk_lending_preclose => [:put], :write_off_lendings => [:get]}

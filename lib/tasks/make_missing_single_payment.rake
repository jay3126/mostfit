...
namespace :mostfit do
  namespace :suryoday do
    ...
    desc "records a single payment for loans missed for payments to match the POS data in uploads"
    task :make_missing_single_payment, :directory do |t, args|
      require 'fastercsv'
      USAGE = <<USAGE_TEXT
[bin/]rake mostfit:suryoday:make_missing_single_payment[<'directory'>]
